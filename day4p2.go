...
func onedouble(i int) bool {
    ...
    if (ia[0] == ia[1]) ||
        ...
        if ia[0] == ia[1] && ia[1] == ia[2] { // DDD+++ Out
            b = false
        }

        if ia[0]==ia[1] && ia[1] == ia[2] && ia[2] == ia[3] { // DDDD++ OK
            b= true
        } else     if ia[1] == ia[2] && ia[2] == ia[3] { // +DDD++ Out
            b = false
        }

        if ia[1] == ia[2] && ia[2] == ia[3] && ia[3] == ia[4] { // +DDDD+ Out
            b = false
        }

        if ia[2] == ia[3] && ia[3] == ia[4] { // ++DDD+ Out
            b = false
        }

        if ia[2] == ia[3] && ia[3] == ia[4] && ia[4] == ia[5] { // ++DDDD Out
            b = true
        ...
        if ia[0] == ia[1] && ia[1] == ia[2] && ia[2] == ia[3] && ia[3] == ia[4] { // DDDDD+ OK
            b = false
        }
